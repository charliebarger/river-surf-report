...
const Contact = () => {
  ...
  return (
    <main>
      ...
      <section className=" my-4 flex-1 border-y-2 border-primaryColor bg-slate-200 p-10 py-6 text-left">
        <Link href={"/freestickers"} className="flex flex-col items-center">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
            Free Stickers!
          </h2>

          <div className=" rounded-full border-8 border-black p-8 ">
            <Image
              alt="rever otter taking notes"
              height={100}
              width={100}
          ...
          <span>Click Here To Get Yours</span>
        </Link>
      </section>
    </main>
  );
