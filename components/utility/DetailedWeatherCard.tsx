...
export type DetailedWeatherCardPropsWithoutChartData = Omit<
  DetailedWeatherCardProps,
  "riverData" // Omit the 'riverData' property
> & {
  riverData: Omit<DetailedWeatherCardProps["riverData"], "flow"> & {
    flow: Omit<DetailedWeatherCardProps["riverData"]["flow"], "chartData">;
  };
};

export const BaseWeatherCard = (
  props: DetailedWeatherCardPropsWithoutChartData
) => {
